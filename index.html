...
<html lang="en">
    ...
    <body>
        ...
        <main>
                    ...
                    <div class="hero">
                        <div class="navbar">
                            <div class="hero-left">
                                ...
                                <h4 class="hero-si">Information Systems</h4>
                                <p>
                                    This is my portofolio website to showes all. 
                                    <br>Details and work experience can be seen on the CV.
                                </p>
            ...
            <aside id="about">
                ...
                <div class="data">
                    ...
                    <p>
                        I am an active student at the Universitas Pembangunan Nasional Veteran Jawa Timur, Information Systems study program. 
                        I have a strong interest in the fields of UI/UX design, Web Development. I have developed my skills and knowledge in 
                        attractive and functional user interface design. I have experience in working in a team, good communication, 
                        and good problem solving skills. I am excited to continue learning and growing in the technology industry 
                        involving application design and development.
                    </p>
                    <a href="/CV.pdf">
                        <button class="btn" target="_blank">RESUME CV</button>
                    </a>
                </div>
              </aside>
            <!-- END ABOUT ME -->   
            ...
            <article id="portofolio">
                <div class="portofolios main-container">
                    <h1 class="section-title">My Portfolio Featured</span></h1>
                    ...
                    <div class="portofolio">
                        <div class="portofolio-cover">
                        <img
                            src="assets/images/portfolios/portfolio3.jpeg"
                            alt="Portfolio 3"
                        />
                        </div>
                        <div class="portofolio-info">
                        ...
                        <p>
                            The admin dashboard is the final project for the Data warehouse & OLAP
                            course by making a case study and linked to the admin dashboard.
                        </p>
                        </div>
                    </div>
                    </div>
                ...
                <div class="skills main-container">
                    ...
                    <div class="skills-grid">
                        <div class="skills-left">
                            <div class="education">
                                ...
                                <div class="education-info">
                                    <h4 class="education-title">UPN "Veteran" Jawa Timur</h4>
                                    <p>Information Systems</p>
                                    <h4 class="education-years">2021 - 2025 (Expected)</h4>
                                </div>
                            </div>
                            <div class="education">
                                <div class="line">
                                ...
                                <div class="education-info">
                                    <h4 class="education-title">SMAN 12 Surabaya</h4>
                        ...
                        <div class="skills-right">
                            <p>
                                For 1-2 years, I continued to learn in the areas of design, 
        ...
        <!-- Footer -->
        <footer>
            <p>&#169; 2023 - Made by Putri Dia Lestari</p>
        </footer>
        <!-- End Footer -->
